...
<div class="container d-flex justify-content-center">
    ...
    <div class="" style="background-color: #ddd; width: 400px; border: 1px solid #bec2c6; border-radius: 5px;">
        ...
        <table class="table table-bordered table-sm w-100 mb-0 table-dark" >
            <thead class="" style="">
            ...
            <tbody>
                ...
                for ($i = 0; $i < $linhas; $i++) {
                    ...
                    for ($index = 0; $index < 7; $index++) {
                        ...
                        echo "<td class><span class='setas2 sp'>".$dia_x."</span>".((Aula::temAulaNesteDia($usuario->getIdusuario(), $aula->getPdo(), $dia_x2))? "<a class='setas2' href='index.php?data=" . $dia_x2 ."'> <i class='fab fa-twitter-square fa-lg'></i></a>":"")."</td>";
